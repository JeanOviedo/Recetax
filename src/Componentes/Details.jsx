mport React, { Fragment, useState, useEffect } from "react";
        ...
        {Datos.length ? (
          <> 
            ...
            <h3>{Datos[0].name}</h3>
              ...
              <h2>Temperamento :<span> {Datos[0].temperament.temperament} </span></h2> 
              
              {/* <h2> <IoFitness/>Vaccines :</span></h2><h1>{Datos[0].vaccines} </h1> */}
              
              <h2>Especie : <span> {Datos[0].species.specie}  </span></h2> 
          
              <h2>     Estado : <span> {Datos[0].petStatus.status}</span></h2>
